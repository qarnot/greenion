...
openssl req -newkey rsa:2048 -nodes -subj "/C=FR/O=GREENION/CN=1234" -keyout key.pem -out key.csr
...
openssl req -x509 -sha256 -nodes -subj "/C=FR/O=GREENION/CN=GREENION-CA" -days 1825 -newkey rsa:2048 -keyout rootCA.key -out rootCA.crt

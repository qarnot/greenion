...
const machineOutputSchema = z.object({
  ...
  name: z.coerce.string().openapi({ example: 'MainframeServer1' }),
...
const machineAndCertificatesOutputSchema = z.object({
...
export { machineInputSchema, machineAndCertificatesOutputSchema };
